...
import { ShieldCheck, RefreshCw, LogOut, CheckCircle } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0066cc] relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative">
          ...
          <p className="text-blue-200 text-lg leading-relaxed">
            We sent a 6-digit code to your email. Enter it to confirm it's really you.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="w-12 h-12 bg-blue-50 rounded-2xl flex items-center justify-center mb-6">
            <ShieldCheck size={22} className="text-[#0066cc]" />
          </div>

          <h1 className="text-3xl font-black text-gray-900 mb-1">Verify your identity</h1>
          ...
          <div className="mt-6 pt-5 border-t border-gray-100">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 text-sm text-gray-500 hover:text-red-500 py-2.5 rounded-xl hover:bg-red-50 transition-all"
            >
              <LogOut size={14} />
